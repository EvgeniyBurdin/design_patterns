...
давая шанс обработать запрос нескольким объектам. Связывает объекты-получатели
...
client.response(400)  # Код 400 не обработан
client.response(404)  # Ответ на код 404: Страница не найдена
client.response(500)  # Ответ на код 500: Ошибка сервера
